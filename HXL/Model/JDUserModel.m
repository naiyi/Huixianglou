...
- (id)initWithCoder:(NSCoder *)aDecoder {
    if (self = [super init]) {
        self.currentOrderCount = [aDecoder decodeIntForKey:@"currentOrderCount"];
        ...
        self.historyOrderCount = [aDecoder decodeIntForKey:@"historyOrderCount"];
        ...
        self.scoreNum1 = [aDecoder decodeIntForKey:@"scoreNum1"];
        self.scoreNum2 = [aDecoder decodeIntForKey:@"scoreNum2"];
        self.scoreTime1 = [aDecoder decodeObjectForKey:@"scoreTime1"];
        self.scoreTime2 = [aDecoder decodeObjectForKey:@"scoreTime2"];
        self.scoreTotal = [aDecoder decodeIntForKey:@"scoreTotal"];
    }
    return self;
}

- (void)encodeWithCoder:(NSCoder *)aCoder {
    [aCoder encodeInt:self.currentOrderCount forKey:@"currentOrderCount"];
    ...
    [aCoder encodeInt:self.historyOrderCount forKey:@"historyOrderCount"];
    ...
    [aCoder encodeInt:self.scoreNum1 forKey:@"scoreNum1"];
    [aCoder encodeInt:self.scoreNum2 forKey:@"scoreNum2"];
    [aCoder encodeObject:self.scoreTime1 forKey:@"scoreTime1"];
    [aCoder encodeObject:self.scoreTime2 forKey:@"scoreTime2"];
    [aCoder encodeInt:self.scoreTotal forKey:@"scoreTotal"];
}
